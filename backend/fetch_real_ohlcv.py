...
SYMBOLS = [
    ...
    "FBNH", "STANBICIBTC", "GEREGU", "BUAFOODS", "NB",
    "OKOMUOIL", "PRESCO", "FCMB", "TRANSCORP", "FLOURMILL",
...
NGNMARKET_VARIANTS: Dict[str, List[str]] = {
    "FBNH":        ["FBNH", "FBNHOLDINGS"],
    "FLOURMILL":   ["FLOURMILL", "FLOURMILLS"],
...
AVG_VOLUMES: Dict[str, int] = {
    ...
    "UBA": 15_000_000, "FBNH": 20_000_000, "STANBICIBTC": 1_500_000,
    "GEREGU": 500_000, "BUAFOODS": 1_000_000, "NB": 800_000,
    "OKOMUOIL": 300_000, "PRESCO": 250_000, "FCMB": 10_000_000,
    "TRANSCORP": 5_000_000, "FLOURMILL": 600_000, "JBERGER": 850_000,
